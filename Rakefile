...
def mkLipoArgs(lib)
	"-create -arch armv7s armv7s/#{lib}.a -arch arm64 arm64/#{lib}.a -arch i386 i386/#{lib}.a -output universal/#{lib}.a"
end
...
task :build_ffmpeg => [:check_gas_preprocessor, :build_ffmpeg_i386, :build_ffmpeg_armv7s, :build_ffmpeg_arm64, :build_ffmpeg_universal]
